...
<head>
    ...
    <title>SERTIKOM BNSP 2021</title>
            ...
            <div class="container">
                <div class="row intro-text align-items-center justify-content-center">
                    ...
                    <h1><strong class="d-block" style="color: white;">WELCOME TO</strong></h1>
                        <h1><strong class="d-block" style="color: white;">BNSP SERTIKOM OBSERVATION TEST-2021</strong></h1>
                        <strong class="d-block text-white text-uppercase letter-spacing">By: Osy Krisdayanti</strong><br>
